...
def generate_product_placement(room_image_path, product_image_path, output_path):
    client = OpenAI(
...
if __name__ == "__main__":
    if len(sys.argv) != 4:
        print("Kullanım: python gpt.py <oda_gorseli> <urun_gorseli> <cikti_dosyasi>")
        sys.exit(1)
    ...
    success, message = generate_product_placement(room_image, product_image, output_file)
    if success:
